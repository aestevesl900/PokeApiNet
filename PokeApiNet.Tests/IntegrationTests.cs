...
namespace PokeApiNet.Tests
{
    public class IntegrationTests
    {
        ...
        public async Task GetPokemonSpeciesResolveAllAsyncIntegrationTest()
        {
            ...
            // act
            System.Collections.Generic.List<EggGroup> eggGroups = await client.GetResourceAsync(pokemonSpecies.EggGroups);
        ...
        public async Task GetContestEffectPagedResourceIntegrationTest()
        {
            ...
            // act
            List<ContestEffect> page = await client.GetApiResourcePageAsync<ContestEffect>();
        ...
        public async Task GetSuperContestEffectPagedResourceIntegrationTest()
        {
            ...
            // act
            List<SuperContestEffect> page = await client.GetApiResourcePageAsync<SuperContestEffect>();
        ...
        public async Task GetMachinePagedResourceIntegrationTest()
        {
            ...
            // act
            List<Machine> page = await client.GetApiResourcePageAsync<Machine>();
        ...
        public async Task GetCharacteristicPagedResourceIntegrationTest()
        {
            ...
            // act
            List<Characteristic> page = await client.GetApiResourcePageAsync<Characteristic>();
