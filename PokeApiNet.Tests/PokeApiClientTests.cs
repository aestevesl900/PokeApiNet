...
namespace PokeApiNet.Tests
{
    public class PokeApiClientTests
    {
        ...
        public async Task UrlNavigationResolveAllAsync()
        {
            ...
            {
                Attributes = new System.Collections.Generic.List<NamedApiResource<ItemAttribute>>
            {
            ...
            // act
            System.Collections.Generic.List<ItemAttribute> attributes = await client.GetResourceAsync(item.Attributes);
        ...
        public async Task GetApiResourcePageAsync()
        {
            ...
            // act
            List<EvolutionChain> page = await client.GetApiResourcePageAsync<EvolutionChain>();
        ...
        public async Task GetApiResourcePageLimitOffsetAsync()
        {
            ...
            // act
            List<EvolutionChain> page = await client.GetApiResourcePageAsync<EvolutionChain>(1, 50);
        ...
        private List<T> CreateFakeApiResourceList<T>()
            where T : ApiResource
        {
            return new List<T>()
            {
                ...
                Results = new System.Collections.Generic.List<ApiResource<T>>()
            };
        }
            ...
            where T : NamedApiResource
        {
            return new NamedApiResourceList<T>()
            {
                Next = "test-next",
                Previous = "test-previous",
                Results = new System.Collections.Generic.List<NamedApiResource<T>>()
            };
        }
