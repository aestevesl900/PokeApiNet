...
namespace PokeApiNet
{
    ...
    public class List<T> : ResourceList<T> where T : ApiResource
    {
        /// <summary>
        /// A list of un-named API resources.
        /// </summary>
        public System.Collections.Generic.List<ApiResource<T>> Results { get; set; }
    }
    ...
    public class NamedApiResourceList<T> : ResourceList<T> where T : NamedApiResource
    {
        ...
        /// </summary>
        public System.Collections.Generic.List<NamedApiResource<T>> Results { get; set; }
    }
}
